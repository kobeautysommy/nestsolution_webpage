...
const services = [
  {
    ...
    details: [
      { t: '환자 동선 완전 재설계', d: '접수→대기→진료→수납까지 모든 접점에서 불편함을 제거하고 감동 포인트를 심습니다.' },
      { t: '직원 CS 교육\n시스템 구축', d: '일회성 교육이 아닌 지속 가능한 CS 문화를 만드는 체계적 커리큘럼. 롤플레이 기반 실전 교육.' },
      { t: '전화 응대 &\n민원 처리 매뉴얼', d: '첫 전화부터 예약까지, 민원 상황 응대 매뉴얼을 실전 연습으로 완성합니다.' },
      { t: '온라인 리뷰 관리 전략', d: '네이버·구글 리뷰 관리 전략으로 신규 환자의 선택 기준이 되는 평판을 쌓습니다.' },
    ],
    steps: [
  ...
  },
  {
    ...
    details: [
      { t: '네이버 지역 검색 최적화', d: '네이버 플레이스·블로그 SEO 전략으로 우리 지역 환자 검색 상위 노출을 목표합니다.' },
      { t: 'SNS & 콘텐츠 마케팅', d: '인스타그램·유튜브를 활용한 신뢰 기반 콘텐츠로 자연스러운 환자 유입을 만듭니다.' },
      { t: '퍼포먼스 광고 운영', d: '네이버 파워링크·카카오 광고 전환율 중심으로 운영해 광고비 대비 효율을 극대화합니다.' },
  ...
  },
  {
    ...
    details: [
      { t: '숨은 진료비 발굴', d: '청구 누락·미청구 항목 분석으로 기존 진료만으로도 수익을 높이는 방법을 찾습니다.' },
      { t: '운영 동선 최적화', d: '환자 흐름과 직원 동선을 재설계해 대기시간을 줄이고 처리량을 극대화합니다.' },
      { t: '행정·청구 시스템 구축', d: '별도 청구 직원 없이도 운영 가능한 체계적 행정 시스템을 설계합니다.' },
      { t: '수익 구조 분석 & 개선', d: '매출·비용 구조 전반을 분석해 지속 가능한 수익성 향상 전략을 수립합니다.' },
    ],
    steps: [
  ...
  },
  {
    ...
    details: [
      { t: '채용 전략 & 인재 선별', d: '우리 병원 문화에 맞는 인재를 선별하는 기준과 면접 프로세스를 설계합니다.' },
      { t: '직무별 교육 커리큘럼', d: '물리치료사·간호조무사·행정직 각각의 직무에 맞는 맞춤 교육 프로그램을 제공합니다.' },
      { t: '조직 문화 &\n동기부여 설계', d: '직원이 오래 머물고 싶은 병원 조직 문화를 설계하고 동기부여 시스템을 구축합니다.' },
      { t: '인력 운영 매뉴얼 (SOP)', d: '원장님 없이도 돌아가는 표준 운영 절차서와 인력 관리 매뉴얼을 제작합니다.' },
    ],
    steps: [
...
export function Services() {
  ...
  return (
    <div style={{ background: LIGHT.bg0 }}>
      <PageBanner
        label="Core Services"
        title={<>네스트솔루션의<br /><span className="text-grad">핵심 서비스</span></>}
